...
{
    public Task<MultiPlace?> GetPlaceByTaskKey(int taskKey, CancellationToken cancellationToken = default)
    {
        throw new NotImplementedException();
    }

    public Task<MultiPlace?> GetPlaceByAddress(string addr, CancellationToken cancellationToken = default)
    {
        throw new NotImplementedException();
    }

    public Task<int> GetMaxPlaceNumber(short m, string profileAddr, CancellationToken cancellationToken = default)
    {
        throw new NotImplementedException();
    }

    public void AddPlace(MultiPlace multiPlace)
    {
        throw new NotImplementedException();
    }

    public void UpdatePlace(MultiPlace place)
    {
        // do nothing here
    }
