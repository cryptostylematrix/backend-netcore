-- Creates the Silver Matrix referral program, structures 0 through 2, and the
...
BEGIN
    ...
    IF v_inserted_structures <> 3 OR v_inserted_places <> 3 THEN
        RAISE EXCEPTION
            'Silver Matrix verification failed: expected 3 structures and 3 places, found % structures and % places.',
