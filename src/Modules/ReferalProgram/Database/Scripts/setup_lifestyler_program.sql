...
BEGIN
    ...
    IF v_inserted_structures <> 12 OR v_inserted_places <> 12 THEN
        RAISE EXCEPTION
            'LifeStyler verification failed: expected 12 structures and 12 places, found % structures and % places.',
