-- Creates the Elite referral program, structures 0 through 7, and the first
...
--
-- Elite structure geometry:
--   0: referral structure, width 0, height 1
--   1-6: width 4, height 1
--   7: width 2, height 1
-- Structures 3-7 require a place in the immediately preceding structure.
-- Elite 2 intentionally does not require an Elite 1 place.
--
...
BEGIN
    ...
    LOOP
        ...
        (
            ...
            CASE
                WHEN v_structure_number = 0 THEN 0
                WHEN v_structure_number = 7 THEN 2
                ELSE 4
            END,
            1,
            1,
            v_structure_number BETWEEN 3 AND 7,
            v_pos_algo
        );
    ...
    IF v_inserted_structures <> 8 OR v_inserted_places <> 8 THEN
        RAISE EXCEPTION
            'Elite verification failed: expected 8 structures and 8 places, found % structures and % places.',
