-- Creates the Gold Matrix referral program, structures 0 through 4, and the
...
BEGIN
    ...
    IF v_inserted_structures <> 5 OR v_inserted_places <> 5 THEN
        RAISE EXCEPTION
            'Gold Matrix verification failed: expected 5 structures and 5 places, found % structures and % places.',
