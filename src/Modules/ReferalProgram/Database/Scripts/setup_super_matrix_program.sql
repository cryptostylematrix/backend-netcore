-- Creates the Super Matrix referral program, structures 0 through 4, and the
...
BEGIN
    ...
    LOOP
        ...
        (
            ...
            CASE WHEN v_structure_number = 0 THEN 0 ELSE 3 END,
            1,
            1,
            v_structure_number BETWEEN 2 AND 4,
            v_pos_algo
        );
    ...
    IF v_inserted_structures <> 5 OR v_inserted_places <> 5 THEN
        RAISE EXCEPTION
            'Super Matrix verification failed: expected 5 structures and 5 places, found % structures and % places.',
