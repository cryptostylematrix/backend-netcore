...
internal abstract class PlaceQueriesStub : IPlaceQueries
{
    ...
    public virtual Task<bool> HasProfilePlacesOutsideInviteStructureAsync(string marketingAddr, string profileAddr, CancellationToken cancellationToken) => throw new NotSupportedException();
