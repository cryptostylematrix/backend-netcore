...
public sealed class RelativePlaceResolverTests
{
    ...
    private sealed class PlaceQueries(IEnumerable<PlaceResponse> places) : IPlaceQueries
    {
        ...
        public Task<Paginated<PlaceResponse>> GetPlacesAsync(string marketingAddr, byte structureNumber, string profileAddr, int page, int pageSize, CancellationToken cancellationToken) => throw new NotSupportedException();
        ...
        public Task<PlaceSubtreeCounts> GetPlaceSubtreeCountsAsync(string marketingAddr, byte structureNumber, string mpPrefix, byte height, CancellationToken cancellationToken) => throw new NotSupportedException();
        ...
        public Task<IReadOnlyList<PlaceResponse>> GetUnfilledPlacesInDepthWindowAsync(string marketingAddr, byte structureNumber, string rootMp, byte width, byte depthSpread, CancellationToken cancellationToken) => throw new NotSupportedException();
        public Task<PlaceResponse?> GetFirstActiveUnfilledPlaceAsync(string marketingAddr, byte structureNumber, string rootMp, byte width, bool profiledPlacesPrioritized, byte depthSpread, CancellationToken cancellationToken) => throw new NotSupportedException();
